...
<template>
    <AuthBase title="Login" description="Input alamat email dan kata sandi anda untuk masuk">
        <Head title="Login" />
            ...
            <div class="grid gap-6">
                ...
                <div class="flex items-center justify-between">
                    <Label for="remember" class="flex items-center space-x-3 hover:cursor-pointer">
                        <Checkbox id="remember" class="hover:cursor-pointer" v-model="form.remember" :tabindex="3" />
